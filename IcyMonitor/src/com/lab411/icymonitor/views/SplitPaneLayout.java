...
package com.lab411.icymonitor.views;
...
public class SplitPaneLayout extends ViewGroup {
    ...
    private void extractAttributes(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mSplitterSize = a.getDimensionPixelSize(R.styleable.SplitPaneLayout_splitterSize, 16);
            ...
            if (value != null) {
                if (value.type == TypedValue.TYPE_REFERENCE ||
                    ...
                    mSplitterDraggingDrawable = a.getDrawable(R.styleable.SplitPaneLayout_splitterDraggingBackground);
                        ...
                        value.type == TypedValue.TYPE_INT_COLOR_RGB8 ||
                        value.type == TypedValue.TYPE_INT_COLOR_RGB4) {
                    mSplitterDraggingDrawable = new PaintDrawable(a.getColor(R.styleable.SplitPaneLayout_splitterDraggingBackground, 0xAA666666));
                }
            } else {
                mSplitterDraggingDrawable = new PaintDrawable(0xAA666666);
            }
            a.recycle();
        }
    }
