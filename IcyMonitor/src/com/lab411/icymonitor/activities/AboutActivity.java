...
import com.lab411.icymonitor.fragments.about.AboutAppFragment;
import com.lab411.icymonitor.fragments.about.AboutLibrariesFragment;
import com.lab411.icymonitor.views.PagerSlidingTabStrip;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.item_github:
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://lab411.github.io/Icy-Monitor/"));
                startActivity(browserIntent);
                return true;
            case R.id.item_contact:
                Uri uri = Uri.parse("mailto:lab411.s@gmail.com");
